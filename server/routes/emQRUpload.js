...
router.post("/emQRUpload", (req, res) => {
  try {
    ...
    let alergyNot = req.body.alergy;
    let alergyNonen = req.body.alergyNone;
    let alergyn = alergyNot + alergyNonen;
    let alergyUsern = req.body.alergyUser;
    let sideEffn = req.body.sideEff;
    let SecretKey = notUsing;
    let phoneNot = req.body.phone;
    let phoneNone = req.body.PhoneNone;
    let phonen = phoneNone + phoneNot;
